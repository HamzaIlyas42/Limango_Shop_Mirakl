...
| --------------------------------- | ------ | ----------- | ----------------- |
| `createShop`                      | —      | —           | From source parse |
| `createShopForPartnerIntegration` | —      | —           | From source parse |
            ...
            List<Account> accounts = [
                SELECT
                    ...
                    (
                        ...
                        FROM Contacts
                        WHERE RoleMarketplace__c = 'Mirakl Invitation'
                    ),
                    (
